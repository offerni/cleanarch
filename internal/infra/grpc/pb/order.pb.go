...
func (x *FetchOrderResponse) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
func (x *FetchOrderResponse) GetPrice() float32 {
	if x != nil {
		return x.Price
	}
	return 0
...
func (x *FetchOrderResponse) GetTax() float32 {
	if x != nil {
		return x.Tax
	}
	return 0
...
func (x *FetchOrderResponse) GetFinalPrice() float32 {
	if x != nil {
		return x.FinalPrice
	}
	return 0
...
type ListOrdersResponse struct {
	...
	Data []*FetchOrderResponse `protobuf:"bytes,1,rep,name=data,proto3" json:"data,omitempty"`
}
...
func (x *ListOrdersResponse) GetData() []*FetchOrderResponse {
	if x != nil {
		return x.Data
	}
	return nil
...
var file_internal_infra_grpc_protofiles_order_proto_rawDesc = []byte{
	...
	0x28, 0x02, 0x52, 0x0a, 0x66, 0x69, 0x6e, 0x61, 0x6c, 0x50, 0x72, 0x69, 0x63, 0x65, 0x22, 0x6d,
	0x0a, 0x12, 0x46, 0x65, 0x74, 0x63, 0x68, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x52, 0x65, 0x73, 0x70,
	...
	0x73, 0x74, 0x22, 0x40, 0x0a, 0x12, 0x4c, 0x69, 0x73, 0x74, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x73,
	0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x2a, 0x0a, 0x04, 0x64, 0x61, 0x74, 0x61,
	0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x16, 0x2e, 0x70, 0x62, 0x2e, 0x46, 0x65, 0x74, 0x63,
	0x68, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x52, 0x04,
	0x64, 0x61, 0x74, 0x61, 0x32, 0x8b, 0x01, 0x0a, 0x0c, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x53, 0x65,
...
var file_internal_infra_grpc_protofiles_order_proto_goTypes = []any{
	...
	(*FetchOrderResponse)(nil),  // 2: pb.FetchOrderResponse
...
var file_internal_infra_grpc_protofiles_order_proto_depIdxs = []int32{
	2, // 0: pb.ListOrdersResponse.data:type_name -> pb.FetchOrderResponse
